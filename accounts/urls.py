...
urlpatterns = [
    ...
    url(r'^registrcompleteation/', views.complete_view, name='account_confirm_complete'),
    url(r'^password-reset/confirm/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',PasswordSetView.as_view(), name='password_reset_confirm'),
    # Default urls
